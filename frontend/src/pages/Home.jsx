      ...
      <div className="relative z-10">
        ...
        <div className="w-screen px-4 py-16 sm:py-20 md:py-24 transition-colors duration-300 bg-[#fffaf4]/80 dark:bg-gray-900/80 backdrop-blur-sm">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {/* Real-time Location */}
            <Link to="/dashboard" className="group hover:bg-white dark:hover:bg-gray-800 p-8 rounded-2xl transition-all duration-300 border border-transparent hover:border-green-100 dark:hover:border-green-900 hover:shadow-xl text-center flex flex-col items-center cursor-pointer">
            ...
            {/* Direct Chat */}
            <Link to="/dashboard" className="group hover:bg-white dark:hover:bg-gray-800 p-8 rounded-2xl transition-all duration-300 border border-transparent hover:border-orange-100 dark:hover:border-orange-900/30 hover:shadow-xl text-center flex flex-col items-center cursor-pointer">
            ...
            {/* Notifications */}
            <Link to="/notifications/history" className="group hover:bg-white dark:hover:bg-gray-800 p-8 rounded-2xl transition-all duration-300 border border-transparent hover:border-green-100 dark:hover:border-green-900 hover:shadow-xl text-center flex flex-col items-center cursor-pointer">
              <div className="w-16 h-16 bg-green-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center text-[#2f855a] dark:text-green-400 mb-6 group-hover:scale-110 transition-transform duration-300">
                <span className="text-3xl">🔔</span>
              </div>
            ...
            <button 
              ...
              className="group hover:bg-white dark:hover:bg-gray-800 p-8 rounded-2xl transition-all duration-300 border border-transparent hover:border-orange-100 dark:hover:border-orange-900/30 hover:shadow-xl text-center flex flex-col items-center cursor-pointer"
            >
              <div className="w-16 h-16 bg-orange-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center text-[#f4a261] mb-6 group-hover:scale-110 transition-transform duration-300">
                <span className="text-3xl">📊</span>
              </div>
